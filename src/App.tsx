...
// Fix: The Gemini API guidelines require using process.env.API_KEY.
// We declare 'process' here to satisfy the TypeScript compiler in a browser environment.
...
const App: React.FC = () => {
    ...
    const startRecording = async () => {
        ...
        try {
            ...
            // Fix: Use process.env.API_KEY as required by Gemini API guidelines.
